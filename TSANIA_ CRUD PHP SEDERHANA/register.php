    ...
    <div class="container mt-3">
        <div class="wrapper">
            ...
            <form class="p-3 mt-3" action="" method="post">
                ...
                <button class="btn mt-3"  type="submit" name="register">Daftar</button>
            </form>
            <div class="text-center fs-6">
                <a href="#">Sudah memiliki akun? </a> <a href="login.php" style="text-decoration: underline; color: #040A18">Masuk</a>
            </div>
        </div>
